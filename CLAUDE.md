...
| 機能 | 競合(2026-07 実勢) | WorkoutKit |
|---|---|---|
| フォームガイド | 動画/アニメ(日本語キューなし)、JP アプリはテキストのみ | **注釈付き実写+日本語キュー(業界唯一)** |
| AI | SmartGym がオンデバイス FM 先行、Hevy はサーバー型生成 | オンデバイス+**フォームキュー連携**(要約がフォームの要点を参照) |
| レストタイマー | Live Activities は Hevy/Fitbod/SmartGym/Strong 対応済(業界標準) | 対応(参入資格。訴求の主役にはしない) |
| Apple Watch | フルアプリが主流 | Smart Stack ウィジェット(軽量方針) |
| 日本価格 | Hevy ¥300/月、BurnFit ¥690〜990/月、OWN. ¥980/月 | **¥680/月・¥4,900/年** |

> 2026-07 競合評価で全面改訂。詳細は docs/competitive-improvement-plan.md 参照。
...
- 平均月額サブ(iOS米国):$15.20、年額:$44.60 → ¥680/月(2026-07 改定)は競争力ある価格
...
|---|---|---|---|---|
| `workoutkit_monthly_680` | Auto-Renewable Subscription | ¥680/月 | 7日間無料 | WorkoutKit プレミアム(月額) |
| `workoutkit_yearly_4900` | Auto-Renewable Subscription | ¥4,900/年 | 7日間無料 | WorkoutKit プレミアム(年額) |

> **¥4,900/年 = 月あたり約¥408 → 年額は月額より¥3,260お得**(UI上でバッジ表示)。算式: 月額 ¥680 × 12 = ¥8,160、年額 ¥4,900 を引いて差額 ¥3,260。旧月額 SKU `workoutkit_monthly_980`(¥980)はローンチ前に非公開化し、¥6,860 バッジ表記は廃止(2026-07-16 価格改定)。
...
キーワード(100文字以内):
  筋トレ,ワークアウト,トレーニング,記録,AI,フォーム,やり方,初心者,ジム,筋肉,重量,レスト
```
...
| v1.1 | 2026-07-16 | フォームガイド実装を反映: 実写+注釈 97 種目(28.1%)、2 フレーム(動き表現)5 種目、フレーム自動再生、AI コーチのキュー参照。生成写真パイプラインは docs/phase-c-generation-kit.md 参照 |
| v1.2 | 2026-07-16 | 競合評価反映: 月額 ¥680 へ改定(SKU workoutkit_monthly_680)、ペイウォール訴求を AI(オンデバイス)先頭に変更、§2-2 競合表を 2026-07 実勢へ全面更新、ASO サブタイトル改訂 |
